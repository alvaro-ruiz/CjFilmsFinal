...
public class Movie {
	...
	public Movie(boolean adult, String backdrop_path, Object belongs_to_collection, int budget, Genres[] genres,
			String homepage, int id, String imdb_id, String original_language, String original_title, String overview,
			double popularity, String poster_path, ProductionCompany[] production_companies,
			ProductionCountry[] production_countries, String release_date, int revenue, int runtime,
			SpokenLanguage[] spoken_languages, String status, String tagline, String title, boolean video,
